...
public class DataManager extends AbstractManager<CratesPlugin> {
    ...
    protected void onLoad() {
        this.plugin.runFoliaTaskAsync(() -> this.loadData());
    ...
    public GlobalCrateData getCrateDataOrCreate(@NotNull Crate crate) {
        ...
        this.plugin.runFoliaTaskAsync(() -> this.plugin.getDataHandler().insertCrateData(fresh));
        this.crateDataMap.put(fresh.getCrateId(), fresh);
        return fresh;
    }

    public void deleteCrateData(@NotNull Crate crate) {
        this.plugin.runFoliaTaskAsync(() -> this.plugin.getDataHandler().deleteCrateData(crate));
    ...
    public RewardLimit getRewardLimitOrCreate(@NotNull Reward reward, @Nullable Player player) {
        ...
        this.plugin.runFoliaTaskAsync(() -> this.plugin.getDataHandler().insertRewardLimit(fresh));
    ...
    public void deleteRewardLimit(@NotNull RewardLimit limit) {
        this.plugin.runFoliaTaskAsync(() -> this.plugin.getDataHandler().deleteRewardLimit(limit));
    ...
    public void deleteRewardLimits(@NotNull Crate crate) {
        ...
        this.plugin.runFoliaTaskAsync(() -> this.plugin.getDataHandler().deleteRewardLimits(crate));
    ...
    public void deleteRewardLimits(@NotNull Reward reward) {
        ...
        this.plugin.runFoliaTaskAsync(() -> this.plugin.getDataHandler().deleteRewardLimits(reward));
    ...
    public void deleteRewardLimits(@NotNull UUID playerId) {
        ...
        this.plugin.runFoliaTaskAsync(() -> this.plugin.getDataHandler().deleteRewardLimits(playerId));
