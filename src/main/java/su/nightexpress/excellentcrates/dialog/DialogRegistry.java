...
import su.nightexpress.excellentcrates.util.registry.CrateRegistry;
...
public class DialogRegistry {
    ...
    private final CrateRegistry<DialogKey<?>, Dialog<?>> backendRegistry;

    public DialogRegistry(@NotNull CratesPlugin plugin) {
        this.plugin = plugin;
        this.backendRegistry = new CrateRegistry<>();
    }
